...
public class DateTime01 {
    public static void main(String[] args) {
        ...
        boolean r2 = date1.isAfter(date2); //true
        System.out.println(r2); //false
        //Example 1: Kullanicidan aldiginiz tarih gecmise ait ise
        // "Gecersiz tarih girdiniz" mesaji veriniz.
        //           Kullanicidan aldiginiz tarih gelecege ait ise
        //           "Zamani girebilirsiniz" deyiniz.

        Scanner input = new Scanner(System.in);
        System.out.println("Pleas enter year, month and day nummer in the given order");
        ...
        //Example 2: Kullanicindan dogum tarihini alan ve girdigi tarihin
        // gun ismini bulan kodu yaziniz.
