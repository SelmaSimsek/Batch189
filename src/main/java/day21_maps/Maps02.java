...
public class Maps02 {
    public static void main(String[] args) {
        ...
        //replace("Tom",339,41); methodu map icinde key olarak Tom ve Values u 39 ise  41 e dönüstürür
        //aksi halde dönüstürmez
        ...
        //putIfAvsent("Ayse",77); methodu map te Ayse key olarak yoksa ekler var ise eklemez
        stdAges.putIfAbsent("Ayse",77);
        System.out.println(stdAges);

        //get() ve getOrDefault() methodlari eger aranan eleman
        // map te var ise ikisi de ayni isi yapar value larini verir
        System.out.println(stdAges.get("Tom"));
        stdAges.getOrDefault("Tom", 0);
        ...
        System.out.println(stdAges.getOrDefault("Jerry", 0)); //  0 defaulValue ye ne yazilmissa onu verir
        ...
        // containsKey() methodu key larin icerisinde aranan deger olup olmadigini kontrol eder
        ...
        //remove("Can",19); methodu hem key hem de value yu kontrol eder, eslesirse siler yoksa silmez
