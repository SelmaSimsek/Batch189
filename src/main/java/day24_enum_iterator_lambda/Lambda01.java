...
public class Lambda01 {
    public static void main(String[] args) {
        ...
        /*
        1) Lambda "Functional"(Method) programingdir, digeri "Structured Programing"
        2) Functional programing de ne yapilacak üzerine yogunlasilir
            "Structured Programing" de nasil yapilacak üzerine yogunlasilir
        3) Functional programing Collection lar ve Arrayler ile kullanilir
        4) Lambda (Functional programing) java 8 ile kullanilmaya baslamistir
         */
    ...
    // Bir listedeki elemanlari ayni satirda aralarina bosluk koyarak
    // yazdiran methodu olusturunuz(Structured==yapisal)
