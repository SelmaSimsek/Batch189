...
public enum Cities {
    //sendelon=bagimsiz
    //sabit degismez datalari depolamak icin enum yapisi kullanilir. enum özel bir class cesididir
    ...
    Cities(int plateCode, String cityName, String postaCode) {
    ...
    3) cunku enum icine koymus oldugunuz her bir data bu clastan olusturulmus bir object mantigi ile calisir
    4) enum icerisine koymus oldugumuz her bir sabit default olarak public static ve final bir sekilde tanimlanmistir
    5) bu nedenle enum icindeki her bir enum ismi yazarak nokta koyarak static bir sekilde ulasabilirsiniz
    6) Enumdaki constructor yeni bir object olusturmak icin degil  variablelari
