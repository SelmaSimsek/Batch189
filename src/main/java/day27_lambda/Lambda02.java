...
//Example 6: Verilen text file icindeki text'de kullanilan tum harfleri
        ...
        List<String> harfliste= Files.
                lines(Paths.get("src\\main\\java\\day27_lambda\\LambdaTextFile.txt")).
                map(t-> t.replaceAll("[^a-zA-Z]","")).
                map(t-> t.split("")).flatMap(Arrays::stream).sorted().collect(Collectors.toList());
        System.out.println(harfliste);
